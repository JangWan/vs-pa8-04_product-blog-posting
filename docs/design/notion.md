...
- Notion Blue (`#99d1aa`) as the singular accent color for CTAs and interactive elements
...
- **Notion Blue** (`#99d1aa`): Primary CTA, link color, interactive accent -- the only saturated color in the core UI chrome.
...
### Interactive
- **Link Blue** (`#99d1aa`): Primary link color with underline-on-hover.
...
- **Disabled**: Warm gray (`#a39e98`) text, primary actions reduce to `rgba(0,224,67,0.3)`, ultra-thin border preserved
...
- **DO** reserve Notion Blue `#99d1aa` for CTAs and interactive elements only — it's the singular accent.
...
- **DO** maintain WCAG AA-or-better contrast ratios:
  ...
  - Blue CTA (`#99d1aa`) on white: ~4.6:1 (WCAG AA for large text)
...
- Primary CTA: Notion Blue (`#99d1aa`)
...
- Link: Notion Blue (`#99d1aa`)
- Focus ring: Focus Blue (`#097fe8`)

### Example Component Prompts
- "Create a hero section on white background. Headline at 64px NotionInter weight 700, line-height 1.00, letter-spacing -2.125px, color rgba(0,0,0,0.95). Subtitle at 20px weight 600, line-height 1.40, color #615d59. Blue CTA button (#99d1aa, 4px radius, 8px 16px padding, white text) and ghost button (transparent bg, near-black text, underline on hover)."
...
- "Create navigation: white header. NotionInter 15px weight 600 for links, near-black text. Blue pill CTA 'Get Notion free' right-aligned (#99d1aa bg, white text, 4px radius)."
...
8. Notion Blue (#99d1aa) is the only saturated color in core UI -- use it sparingly for CTAs and links
...
8. **Notion Blue is the one color.** `#99d1aa` anchors CTAs and primary interactive moments. Everything else lives in the warm-neutral scale. Rainbow-accent design would betray the block-as-canvas philosophy.
...
| **Disabled** | Opacity on text and ultra-thin border together. Primary Notion Blue actions become `rgba(0,224,67,0.3)`. |
...
#99d1aa Notion Blue as the sole accent, `1px solid rgba(0,0,0,0.1)`
...
| Border | hairline divider | `#29322c` |
| Muted | subdued surface | `#222a25` |
| Primary | #99d1aa | #99d1aa (unchanged — brand anchor is theme-stable) |
